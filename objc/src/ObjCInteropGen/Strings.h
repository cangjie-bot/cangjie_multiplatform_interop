...
[[nodiscard]] inline bool starts_with(const std::string_view str, const std::string_view prefix)
{
    return str.size() >= prefix.size() && str.compare(0, prefix.size(), prefix) == 0;
}

[[nodiscard]] inline bool ends_with(const std::string_view str, const std::string_view suffix)
{
