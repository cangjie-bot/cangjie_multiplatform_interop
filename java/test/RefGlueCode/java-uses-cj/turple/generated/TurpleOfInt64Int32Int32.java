...
final public class TurpleOfInt64Int32Int32 {
    static {
        loadLibrary("UNNAMED");
    }
    ...
    public TurpleOfInt64Int32Int32(long item1, int item2, int item3) {
        self = initCJObjectlii(item1, item2, item3);
    }

    private TurpleOfInt64Int32Int32(long item1, int item2, int item3, $$NativeConstructorMarker __init__) {
    }

    public native long initCJObjectlii(long item1, int item2, int item3);

    private TurpleOfInt64Int32Int32 (long id, $$NativeConstructorMarker __init__) {
        self = id;
    }
