...
public class A {
    ...
    public void foo(TupleOfInt64Int32Int32 a) {
        fooRN7UNNAMED23TupleOfInt64Int32Int32E(this.self, a.self);
    }

    public native void fooRN7UNNAMED23TupleOfInt64Int32Int32E(long self, long aId);

    public TupleOfInt64Int32Int32 goo(long a, int b, int c) {
        return goolii(this.self, a, b, c);
    }

    public native TupleOfInt64Int32Int32 goolii(long self, long a, int b, int c);
