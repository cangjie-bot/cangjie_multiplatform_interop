...
public interface MessageType {
    ...
    public enum SimpleType implements MessageType {
        ...
        ANNOTATION("annotation", "Compound", "vendor.com.sun.tools.javac.code.Attribute"),
        BOOLEAN("boolean", "boolean", null),
        COLLECTION("collection", "Collection", "java.util"),
        FLAG("flag", "Flag", "vendor.com.sun.tools.javac.code.Flags"),
        FRAGMENT("fragment", "Fragment", null),
        DIAGNOSTIC("diagnostic", "JCDiagnostic", "vendor.com.sun.tools.javac.util"),
        MODIFIER("modifier", "Modifier", "vendor.javax.lang.model.element"),
        FILE("file", "File", "java.io"),
        FILE_OBJECT("file object", "JavaFileObject", "vendor.javax.tools"),
        PATH("path", "Path", "java.nio.file"),
        NAME("name", "Name", "vendor.com.sun.tools.javac.util"),
        NUMBER("number", "int", null),
        OPTION_NAME("option name", "Option", "vendor.com.sun.tools.javac.main"),
        PROFILE("profile", "Profile", "vendor.com.sun.tools.javac.jvm"),
        SOURCE("source", "Source", "vendor.com.sun.tools.javac.code"),
        SOURCE_VERSION("source version", "SourceVersion", "vendor.javax.lang.model"),
        STRING("string", "String", null),
        SYMBOL("symbol", "Symbol", "vendor.com.sun.tools.javac.code"),
        SYMBOL_KIND("symbol kind", "Kind", "vendor.com.sun.tools.javac.code.Kinds"),
        KIND_NAME("kind name", "KindName", "vendor.com.sun.tools.javac.code.Kinds"),
        TARGET("target", "Target", "vendor.com.sun.tools.javac.jvm"),
        TOKEN("token", "TokenKind", "vendor.com.sun.tools.javac.parser.Tokens"),
        TREE_TAG("tree tag", "Tag", "vendor.com.sun.tools.javac.tree.JCTree"),
        TYPE("type", "Type", "vendor.com.sun.tools.javac.code"),
