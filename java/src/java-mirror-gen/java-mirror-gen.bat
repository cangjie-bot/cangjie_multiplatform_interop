...
:setHelp
    ...
    ECHO   .\java-mirror-gen.bat [options] [type-names]
    ECHO     or
    ECHO   .\java-mirror-gen.bat [options] -jar jar-file (single-jar mode)
    ECHO     where
    ...
    ECHO       .\java-mirror-gen.bat -d hmpackage -p hashmap java.util.HashMap
EXIT /B 0
